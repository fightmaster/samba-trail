...
//     });
//     $('.register-trigger-show').click(function(event) {
//         $('#register').show();
...
// Counter
	var endDate = "September 16, 2017 8:00:00";
        $('.countdown.styled').countdown({
          ...
          render: function(data) {
            ...
            $(this.el).html("<div><span>" + this.leadingZeros(data.years, 2) + " </span><strong>years</strong></div><div><span>" + this.leadingZeros(data.days, 3) + " </span><strong>days</strong></div><div><span>" + this.leadingZeros(data.hours, 2) + "  </span><strong>hrs</strong></div><div><span>" + this.leadingZeros(data.min, 2) + "</span><strong>min</strong></div><div><span>" + this.leadingZeros(data.sec, 2) + " </span><strong>sec</strong></div>");
			  ...
			  $(this.el).html("<div><span>" + this.leadingZeros(data.days, 3) + " </span><strong>Д</strong></div><div><span>" + this.leadingZeros(data.hours, 2) + "  </span><strong>Ч</strong></div><div><span>" + this.leadingZeros(data.min, 2) + "</span><strong>Мин</strong></div><div><span>" + this.leadingZeros(data.sec, 2) + " </span><strong>Сек</strong></div>");
			  }
          }
        });
